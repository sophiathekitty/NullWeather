...
class WeatherChartView extends HourlyView{
        ...
        if(this.pollution){
            this.pollution.getData(json=>{
                json.pollution.forEach(hour=>{
                    ...
                    // fine dust
                    $("#weather_chart [hour="+hour.hour+"] .bar.graph [var=pm2_5]").attr("title","Fine Dust -- "+hours+am+"\nClouds: "+Math.round(hour.pm2_5)+" | "+Math.round(hour.pm2_5_min)+" / "+Math.round(hour.pm2_5_max));
    ...
    hour_bars(hour,model,title,alpha = ""){
        ...
        // hum
        $("#weather_chart [hour="+hour.hour+"] .bar.graph [var=hum]"+mdl).attr("title",title+" -- "+hours+am+"\nHumidity: "+Math.round(hour.humidity)+"% | "+Math.round(hour.humidity_min)+"% / "+Math.round(hour.humidity_max)+"%");
        ...
        // wind
        $("#weather_chart [hour="+hour.hour+"] .bar.graph [var=wind_speed]"+mdl).attr("title",title+" -- "+hours+am+"\nWind: "+Math.round(hour.wind_speed)+"mph | "+Math.round(hour.wind_speed_min)+"mph / "+Math.round(hour.wind_speed_max)+"mph");
        ...
        // clouds
        $("#weather_chart [hour="+hour.hour+"] .bar.graph [var=clouds]"+mdl).attr("title",title+" -- "+hours+am+"\nClouds: "+Math.round(hour.clouds)+"% | "+Math.round(hour.clouds_min)+"% / "+Math.round(hour.clouds_max)+"%");
